...
export default function CoachRegisterStep4() {
  return (
    <div>
      <Head>
        <title>Register as Coach - Step 4 - TeamUp India</title>
        <meta name="description" content="Register as a coach on TeamUp India - Step 4: Fees & Availability" />
      </Head>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white p-8 rounded-xl shadow-md border border-gray-200">
            ...
            <div className="mb-6">
              ...
              <p className="text-center text-gray-600 text-sm mt-2">Step 4 of 5: Fees & Availability</p>
            </div>
            
            <form className="space-y-6">
              <div>
                <label htmlFor="fee" className="block text-gray-700 font-medium mb-2">Fee per Session (₹) *</label>
                ...
                <p className="text-gray-500 text-sm mt-1">Set your coaching fee per session</p>
              </div>
              
              <div>
                <label className="block text-gray-700 font-medium mb-2">Preferred Working Days *</label>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'].map((day) => (
                    <div key={day} className="flex items-center">
                      ...
                      />
                      <label htmlFor={day.toLowerCase()} className="ml-2 text-gray-700">{day}</label>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div>
                <label className="block text-gray-700 font-medium mb-2">Time Slots *</label>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  {['6:00 AM - 9:00 AM', '9:00 AM - 12:00 PM', '12:00 PM - 3:00 PM', '3:00 PM - 6:00 PM', '6:00 PM - 9:00 PM', '9:00 PM - 12:00 AM'].map((time, index) => (
                    <div key={index} className="flex items-center">
                      <input 
                        ...
                        className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500" 
                      />
                      <label htmlFor={`time-${index}`} className="ml-2 text-gray-700">{time}</label>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div>
                <label htmlFor="maxSessions" className="block text-gray-700 font-medium mb-2">Max Sessions per Day *</label>
                <select 
                  id="maxSessions" 
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  <option value="">Select maximum sessions</option>
              ...
              <div className="flex justify-between">
                <Link href="/register/coach/step3" className="bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold py-3 px-6 rounded-lg transition duration-300">
                  Back to Step 3
                </Link>
                <Link href="/register/coach/step5" className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg transition duration-300">
                  Continue to Step 5
                </Link>
              </div>
            </form>
