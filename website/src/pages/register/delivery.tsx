...
export default function DeliveryRegister() {
  return (
    <Layout title="Register as Delivery Partner - TeamUp India Sports Platform" description="Register as a delivery partner on TeamUp India to earn by delivering sports equipment">
      <Head>
