...
export default function CoachRegister() {
  return (
    <Layout title="Register as Coach - TeamUp India Sports Platform" description="Register as a coach on TeamUp India to connect with players and grow your business">
      <Head>
          ...
          <div className="bg-white p-8 rounded-xl shadow-md border border-gray-200">
            ...
            <form className="space-y-6">
              ...
              <div className="flex justify-between">
                ...
                <Link href="/register/coach/step2" className="bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-6 rounded-lg transition duration-300">
                  Continue to Step 2
                </Link>
              </div>
            </form>
