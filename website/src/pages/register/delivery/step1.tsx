...
export default function DeliveryRegisterStep1() {
  return (
    <div>
      <Head>
        <title>Register as Delivery Partner - Step 1 - TeamUp India</title>
        <meta name="description" content="Register as a delivery partner on TeamUp India - Step 1: Personal Details" />
      </Head>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white p-8 rounded-xl shadow-md border border-gray-200">
            ...
            <div className="mb-6">
              ...
              <p className="text-center text-gray-600 text-sm mt-2">Step 1 of 5: Personal Details</p>
            </div>
            ...
            <form className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex">
                    ...
                    <input 
                      type="tel" 
                      id="mobile" 
                      className="flex-1 min-w-0 block w-full px-3 py-3 rounded-none rounded-r-md border border-gray-300 focus:ring-purple-500 focus:border-purple-500" 
                      placeholder="Enter your mobile number" 
                    />
                  </div>
                  <button type="button" className="mt-2 text-purple-600 hover:underline text-sm">
                    Send OTP
                  </button>
                </div>
              </div>
              ...
              <div>
                <label htmlFor="selfie" className="block text-gray-700 font-medium mb-2">Live Selfie *</label>
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-500 text-xs mt-1">For verification purposes</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex justify-between">
                ...
                <Link href="/register/delivery/step2" className="bg-purple-500 hover:bg-purple-600 text-white font-semibold py-3 px-6 rounded-lg transition duration-300">
                  Continue to Step 2
                </Link>
              </div>
            </form>
